...
{
    const XML_PATH_DDG_TRANSACTIONAL_ENABLED = 'dotdigitalgroup_transactional_emails/ddg_transactional/enabled';
    const XML_PATH_DDG_TRANSACTIONAL_HOST = 'dotdigitalgroup_transactional_emails/ddg_transactional/host';
    const XML_PATH_DDG_TRANSACTIONAL_USERNAME = 'dotdigitalgroup_transactional_emails/ddg_transactional/username';
    const XML_PATH_DDG_TRANSACTIONAL_PASSWORD = 'dotdigitalgroup_transactional_emails/ddg_transactional/password';
    const XML_PATH_DDG_TRANSACTIONAL_PORT = 'dotdigitalgroup_transactional_emails/ddg_transactional/port';
    const XML_PATH_DDG_TRANSACTIONAL_DEBUG = 'dotdigitalgroup_transactional_emails/ddg_transactional/debug';
