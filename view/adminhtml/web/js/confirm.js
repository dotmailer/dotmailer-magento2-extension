require([
    ...
    function showConfirmation(element) {
        ...
        if (element.attr('id') === 'sync_settings_addressbook_allow_non_subscribers') {
            content = $t('You are about to allow Dotdigital to import customers that haven\'t explicitly opted into your emails. This means the Customers and Guests lists will contain contacts that you might not be able to reach out to, depending on the applicable regulations. Do you wish to continue?');
        } else {
