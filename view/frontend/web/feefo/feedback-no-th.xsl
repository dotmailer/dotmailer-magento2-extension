     ...
     <!-- tr class=row -->
           <div class="comments">
               ...
               <table class="comm-table" style="border-collapse: collapse; border-spacing: 0;">
                   <!--<tr>
                       <th style="text-align: left; border-bottom: 1px black solid;" width="150">Product Name</th>
                       <th style="text-align: left; border-bottom: 1px black solid;" width="100">Date</th>
                       <th style="text-align: left; border-bottom: 1px black solid;" width="90">Rating</th>
                       <th style="text-align: left; border-bottom: 1px black solid;" width="300">Comment</th>
                   </tr>-->
                   <xsl:for-each select="FEEDBACKLIST/FEEDBACK">
                       ...
                       <td width="100"><!-- time tag used here in HTML5 only might cause issues with legacy browsers -->
