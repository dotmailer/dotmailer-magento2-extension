...
class Client extends \Dotdigitalgroup\Email\Model\Apiconnector\Rest
{
    ...
    public function postContactsTransactionalDataImport(
        ...
        if (isset($response->message)) {
            $this->addClientLog('Error sending transactional data');
        }
    ...
    public function postContactsTransactionalData(
        ...
        if (isset($response->message)) {
            $this->addClientLog('Error sending contacts transactional data')
                ->addClientLog('Failed contacts transactional data', [
                    'data' => $apiData,
                ], Logger::DEBUG);
        }
    ...
    public function postAccountTransactionalData(
        ...
        if (isset($response->message)) {
            $this->addClientLog('Error sending account transactional data')
                ->addClientLog('Failed account transactional data', [
                    'data' => $apiData,
                ], Logger::DEBUG);
        }
    ...
    public function deleteContactsTransactionalData(
        ...
        if ($key && $collectionName) {
            ...
            if (isset($response->message)) {
                $this->addClientLog('Error deleting contacts transactional data');
            }
    ...
    public function postCampaignAttachments($campaignId, $data)
    {
        ...
        if (isset($result->message)) {
            $this->addClientLog('Error sending campaign attachments', [
                'campaign_id' => $campaignId,
            ]);
        }
    ...
    public function getContactAddressBooks($contactId)
    {
        ...
        if (isset($response->message)) {
            $this->addClientLog('Error getting contact address books', [
                'contact_id' => $contactId,
            ]);
        }
    ...
    public function getApiTemplate($templateId)
    {
        ...
        if (isset($response->message)) {
            $this->addClientLog('Error getting template', [
    ...
    public function postAccountTransactionalDataImport(
        ...
        if (isset($response->message)) {
            $this->addClientLog('Error sending transactional data to account');
        }
    ...
    public function getContactsImportByImportId($importId)
    {
        ...
        if (isset($response->message)) {
            $this->addClientLog('Error getting contacts import by ID', [
                'import_id' => $importId,
            ]);
        }
    ...
    public function getContactsTransactionalDataImportByImportId($importId)
    {
        ...
        if (isset($response->message)) {
            $this->addClientLog('Error getting contacts transactional data import by ID', [
                'import_id' => $importId,
            ]);
        }
    ...
    public function getContactImportReportFaults($id)
    {
        ...
        if (json_decode($response)) {
            //log error
            if (isset($response->message)) {
                $this->addClientLog('Error contact import report faults', [
                    'contact_id' => $id,
                ]);
            }
    ...
    public function getSendStatus($id)
    {
        ...
        if (isset($response->message)
            ...
            $this->addClientLog('Error getting send status by ID', [
                'send_status_id' => $id,
            ]);
        }
        return $response;
    ...
    public function getAccessToken($url, $params)
    {
        ...
        if ($response === false) {
            $this->addClientLog('Failed to get access token', [
                'error_number' => curl_errno($ch),
            ], Logger::ERROR);
        } elseif (isset($response->error)) {
            $this->addClientLog('Oauth failure when getting access token', [
    ...
    public function postContactWithConsent($contact, $consentFields)
    {
        ...
        if (isset($response->message)) {
            $this->addClientLog('Error sending contact with consent');
            return $response;
        }
    ...
    public function postContactWithConsentAndPreferences($contact, $consentFields, $preferences)
    {
        ...
        if (isset($response->message)) {
            $this->addClientLog('Error sending contact with consent and preferences')
