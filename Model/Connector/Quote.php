...
class Quote
{
	...
	public function setQuote($quoteData)
	{
		...
		$customAttributes
		         = $this->_helper->getConfigSelectedCustomQuoteAttributes(
			$website
		);
		if ($customAttributes) {
	...
	public function __sleep()
	{
		...
		$properties = array_diff(
			$properties,
			['_storeManager', '_objectManager', '_storeManager', '_datetime',
			 '_helper', '_customerFactory', '_productFactory',
			 '_attributeCollection', '_setFactory']
		);
